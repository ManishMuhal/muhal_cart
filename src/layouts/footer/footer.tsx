             ...
             <div className="row">
                <div className="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                   <div className="tpfooter__widget footer-col-1 mb-50">
                      ...
                      <p>If you have any question, please <br/> contact us at: 
                         <a href="mailto:manishmuhal89@gmail.com">manishmuhal89@gmail.com</a>
                      </p>
                ...
                <div className="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                   <div className="tpfooter__widget footer-col-2 mb-50">
                      <h4 className="tpfooter__widget-title">Looking for Muhal Cart?</h4>
                      <p>Churu Rajasthan <br/> churu 331001, Raj.</p>
                      <div className="tpfooter__widget-time-info mt-35">
                         <span>Monday – Friday: <b>9:10 AM – 6:10 PM</b></span>
                ...
                <div className="col-xl-4 col-lg-6 col-md-8 col-sm-7">
                   <div className="tpfooter__widget footer-col-4 mb-50">
                      ...
                      <div className="tpfooter__widget-newsletter">
                         <p>Subscribe to the Muhal cart mailing list to receive updates <br/> on new arrivals & other information.</p>
                         <form>
                            <span>
                              <i>
             ...
             <div className="row">
                <div className="col-lg-6 col-md-7 col-sm-12">
                   <div className="tpfooter__copyright">
                      <span className="tpfooter__copyright-text">Copyright © <a href="#">Muhal Cart</a> all rights reserved.</span>
                   </div>
                </div>
